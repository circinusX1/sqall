...
public:
    ...
    void*  userData(const char* key){if(m_userData.find(key)!=m_userData.end())return m_userData[key];return nullptr;}
    void   setUserData(const char* key, void* p){m_userData[key] = p;}
